...
const ServiceSection = ({title,image,description,dir}:IService) => {
  return (
    <div className={cn("service w-full flex justify-around lg:between items-center flex-wrap-reverse lg:flex-nowrap text-blue-900 dark:text-white p-0  lg:px-20")}>
